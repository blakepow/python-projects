...
class SpaceShooter(arcade.Window):
    ...
    def setup(self):
        ...
        # Setup the player
        self.player = arcade.Sprite(PATH + "images/jet.png", SCALING)
        ...
        self.background_music = arcade.load_sound(
            PATH + "sounds/Apoxode_-_Electric_1.wav"
        )

        # Load our otherPATH +  sounds
        # Sound sources: Jon Fincher
        self.collision_sound = arcade.load_sound(PATH + "sounds/Collision.wav")
        self.move_up_sound = arcade.load_sound(PATH + "sounds/Rising_putter.wav")
        self.move_down_sound = arcade.load_sound(PATH + "sounds/Falling_putter.wav")
    ...
    def add_enemy(self, delta_time: float):
        ...
        enemy = FlyingSprite(PATH + "images/missile.png", SCALING)
    ...
    def add_cloud(self, delta_time: float):
        ...
        cloud = FlyingSprite(PATH + "images/cloud.png", SCALING)
